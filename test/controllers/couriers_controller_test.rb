...
#       post couriers_url, params: { courier: { active: @courier.active, address_id: @courier.address_id, courier_status_id: @courier.courier_status_id, email: @courier.email, phone: @courier.phone, user_id: @courier.user_id } }
#     end
...
#     patch courier_url(@courier), params: { courier: { active: @courier.active, address_id: @courier.address_id, courier_status_id: @courier.courier_status_id, email: @courier.email, phone: @courier.phone, user_id: @courier.user_id } }
